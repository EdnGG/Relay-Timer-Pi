...
# Getting actuators serial number
...
try:
    while counterCicles <= 5:
        ...
        GPIO.output(20, True)
        counter1 = counter1 + 1
        print("Actuator number: " + str(actuatorRelay2) +
              " On relay 2. Cicle #:" + str(counter) + '\n')
        if GPIO.input(ButtonPin) == 0:
            print("Actuator reach the desire distance")
        else:
            print("Actuator dont reach the desire distance")
        ...
        GPIO.output(26, True)
        counter2 = counter2 + 1
        print("Actuator number: " + str(actuatorRelay3) +
              " On relay 3. Cicle #:" + str(counter) + '\n')
        if GPIO.input(ButtonPin) == 0:
            print("Actuator reach the desire distance")
        else:
            print("Actuator dont reach the desire distance")
    ...
    print("Actuator number "+str(actuatorRelay2) +
          " On relay #2 runs: " + str(counter1) + " Cicles")
    print("Actuator number "+str(actuatorRelay3) +
          " On relay #3 runs: " + str(counter2) + " Cicles")
    GPIO.cleanup()
